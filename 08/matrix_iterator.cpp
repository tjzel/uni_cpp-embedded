...
int main() {
  ...
  auto prod =
      std::inner_product(m.row_begin(1), m.row_end(1), m.row_begin(2), 0.0);
  ...
  auto prod2 =
      std::inner_product(m.col_begin(1), m.col_end(1), m.col_begin(3), 0.0);
  cout << "inner product of 1st and 3rd column = " << prod2 << endl;

  Matrix<std::vector<int>, 2, 3> mv = {{{1, 2}, {1, 4, 5}, {1, 2, 3, 4}},
                                       {{1}, {1, 4, 2, 3}, {5, 4}}};
